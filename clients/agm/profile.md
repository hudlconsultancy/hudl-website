...
## Snapshot
- **Slug:** agm
- **Full name:** AGM Group [confirm full company name]
- **Sector:** [to confirm]
- **Website:** [to confirm]
...
- Notes: [confirm full scope/retainer — a dashboard subdomain (agm.hudl.gg) is already reserved]
...
- [ ] Drop any data into `clients/agm/data/`
- [ ] Build the reporting dashboard once data is in

## Working notes
_Chronological log — newest at top._
- 2026-06-04 — Workspace created. (Dashboard subdomain `agm.hudl.gg` already present in `_redirects`.)
